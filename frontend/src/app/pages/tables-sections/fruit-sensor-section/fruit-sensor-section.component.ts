...
@Component({
  selector: 'app-fruit-sensor-section',
  templateUrl: './fruit-sensor-section.component.html',
  styleUrls: ['./fruit-sensor-section.component.css']
})
export class FruitSensorSectionComponent {
 
  tableHeader: string = "FRUIT_SENSOR TABLE INFO" 
  formFields: FormField[] = [
    {
      label: 'ID',
      fieldName: 'ID_FRUIT_SENSOR',
      fieldType: 'text',
      value: ''
    },
    {
  ...
  displayedColumns: string[] =["ID_FRUIT_SENSOR", "NAME_FRUIT_FK", "SENSOR_FK"]

  base_url = "http://127.0.0.1:5000/"
  table_name = "FRUIT_SENSOR_TAB"
